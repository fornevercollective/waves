...
var FOV = (60 / 1600) * Math.PI,
    NEAR = 1,
    FAR = 10000,
    MIN_ASPECT = 16 / 9;
    
var WIND_SPEED_DECIMAL_PLACES = 6,
    SIZE_DECIMAL_PLACES = 0,
    CHOPPINESS_DECIMAL_PLACES = 6;

var SENSITIVITY = 1.0;

var WIND_SPEED_X = -2500;
var MIN_WIND_SPEED_Z = 1000,
    WIND_SPEED_OFFSET = 200;
